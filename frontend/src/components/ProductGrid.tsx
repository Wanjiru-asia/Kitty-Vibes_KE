            ...
            <div className="relative z-10">
                ...
                {newArrivals.length > 0 && (
                    <div className="flex items-center justify-center gap-4 mb-24">
                        ...
                        <div className="size-2 bg-pink-400 rounded-full"></div>
                        <div className="h-px flex-1 bg-gradient-to-r from-transparent via-pink-300 to-transparent"></div>
                    </div>
                )}
                    ...
                    {categories.map(cat => (
                        <button
                            ...
                            className={`px-6 py-3 rounded-full text-sm font-bold transition-all ${
                                activeCategory === cat
                                    ? "bg-pink-600 text-white shadow-lg shadow-pink-300/30 scale-110"
                                    : "text-gray-600 hover:text-pink-600 bg-gray-100 border border-gray-200 hover:border-pink-300 hover:scale-105"
                            }`}
                        >
                            {cat}
                        </button>
